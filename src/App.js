...
const styles = {
  ...
  stars: {
    ...
    backgroundImage: "radial-gradient(white, rgba(255, 255, 255, 0.2) 2px, transparent 40px), radial-gradient(white, rgba(255, 255, 255, 0.14902) 1px, transparent 30px), radial-gradient(white, rgba(255, 255, 255, 0.0980392) 2px, transparent 40px), radial-gradient(rgba(255, 255, 255, 0.4), rgba(255, 255, 255, 0.0980392) 2px, transparent 30px)",
